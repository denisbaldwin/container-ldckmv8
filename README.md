...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ldckmv8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ldckmv8.containers.anotherwebservice.com/
...
```
git clone git@github.com:denisbaldwin/container-ldckmv8.git
cd container-ldckmv8
```
...
```
docker attach container-ldckmv8
```
